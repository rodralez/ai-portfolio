...
p1
ggsave("./images/p1.png", p1, height = he , width = we * aspect_ratio)
```
<p align = "left">
...
p2 
ggsave("./images/p2.png", p2, height = he , width = we * aspect_ratio)
```
<p align = "left">
...
p3
ggsave("./images/p3.png", p3, height = he , width = we * aspect_ratio)
```
<p align = "left">
...
p4
ggsave("./images/p4.png", p4, height = he , width = we * aspect_ratio)
```
<p align = "left">
